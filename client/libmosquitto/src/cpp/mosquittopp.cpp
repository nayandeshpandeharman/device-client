...
//This wrapper Function set_string_option() is added by IgniteClient team for 2WayTLS support changes
int mosquittopp::set_string_option(enum mosq_opt_t option, const char *value)
{
	return mosquitto_string_option(m_mosq, option, value);
}
//This is wrapper function for mosquitto_int_option, added because max_inflight_messages_set() is deprecated.
int mosquittopp::set_int_option(enum mosq_opt_t option, int value)
{
